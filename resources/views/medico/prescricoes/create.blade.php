                ...
                <div class="p-6 md:p-8 text-gray-900 dark:text-gray-100">
                    ...
                    <form method="POST" action="{{ route('medico.prescricoes.store') }}">
                        ...
                        <div class="flex justify-between items-center mb-4">
                            ...
                            {{-- Botão para adicionar novos medicamentos --}}
                        ...
                        {{-- Container onde os blocos de medicamentos serão adicionados --}}
...
document.addEventListener('DOMContentLoaded', function () {
    ...
    // Adiciona um event listener para o container para lidar com a remoção
