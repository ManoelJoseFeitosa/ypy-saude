<x-app-layout>
    ...
    <div class="py-6">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            {{-- Card de Boas-Vindas e Botões de Ação --}}
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg mb-6">
                <div class="p-6 text-gray-900 dark:text-gray-100">
                    <h3 class="text-lg font-medium">Bem-vindo(a), Dr(a). {{ Auth::user()->name }}!</h3>
                    <p class="mt-2">A partir deste painel você pode gerenciar seus pacientes e emitir novos documentos.</p>
                    
                    {{-- ÁREA DOS BOTÕES COM OS LINKS CORRIGIDOS --}}
