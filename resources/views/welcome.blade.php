...
<body class="font-sans text-gray-900 antialiased relative">
    ...
    <div class="absolute left-0 top-0 bottom-0 w-10 bg-blue-800 hidden sm:block z-20"></div>
    <div class="absolute right-0 top-0 bottom-0 w-10 bg-blue-800 hidden sm:block z-20"></div>
    ...
    <div class="min-h-screen bg-white dark:bg-gray-900 flex flex-col">
        ...
        <!-- Rodapé Corrigido -->
        <footer class="bg-blue-800 text-white w-full z-10">
