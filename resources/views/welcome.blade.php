...
<x-layouts.public>
    ...
    <section class="bg-white dark:bg-gray-800">
        <div class="container mx-auto px-6 py-20 text-center">
            ...
            {{-- Parágrafo alterado: classe 'text-lg' mudou para 'text-xl' para aumentar a fonte --}}
            ...
            <div class="mt-8">
                {{-- Botão alterado: rota 'register' mudou para 'planos' --}}
                <a href="{{ route('planos') }}" class="px-8 py-3 bg-piaui-green text-white font-bold rounded-lg hover:bg-opacity-90 text-lg">Comece a Usar Agora</a>
            </div>
        </div>
    </section>
